...
console.log(velociraptor.carnivorous);
...
graduates.forEach(student => {
  let information = `${student.first_name} ${student.email}`;
    information.toString().split();
    contactInfo.push(information);
});
...
*/
const populationTotal = zooAnimals.reduce((accumulatedTotal, currentTotal) => {return accumulatedTotal + currentTotal.population;}, 0);
